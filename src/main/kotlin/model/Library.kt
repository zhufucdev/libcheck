...
class Library(private val workingDir: File) {
    ...
    val Book.inStock
        get() = stock - borrowList.items.count { it.bookId == id && it.returnTime == null }.toUInt()
    ...
    val Reader.borrows get() = borrowList.items.count { it.readerId == id && it.returnTime == null }
